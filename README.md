# docker-node-18-rsync-python-ssh-dig
Node 18 container with rsync, python, ssh and dig support

## Links

- [GitLab repository](https://gitlab.com/kirbo/docker-node-18-rsync-python-ssh-dig)
- [GitHub repository](https://github.com/kirbo/docker-node-18-rsync-python-ssh-dig)
- [Docker repository](https://hub.docker.com/repository/docker/kirbownz/docker-node-18-rsync-python-ssh-dig)
...
```yml
image: kirbownz/docker-node-18-rsync-python-ssh-dig
